...
- Add OpenDCC `.Locxml` import/export ([#172](https://github.com/OpenRemise/Frontend/issues/172))
...
- Bugfix `DarkModeColorMapper` doesn't override `==/hashCode` ([#139](https://github.com/OpenRemise/Frontend/issues/139))
